        ...
        <div class="card border-4 opacity-80 mx-auto h-screen overflow-hidden flex items-center justify-center px-8 pt-6 pb-8 mb-4" style="background: #edf2f7;">
            <div class="card border-1 border-gray-800 opacity-95 bg-gray-400 text-gray-900 shadow-2xl rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                ...
                <div class="mb-4 text-black">
                    ...
                    <input onChange={handleChange} class=" text-black shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="firstname" type="text" placeholder="Name" />
                </div>

                <div class="mb-4 text-black">
                    <label class="block text-grey-darker text-sm font-bold mb-2" for="surname">Last Name      </label>
                    <input onChange={handleChange} class=" text-black shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="surname" type="text" placeholder="Surname" />
                </div>

                <div class="mb-4 text-black">
                    <label class="block text-grey-darker text-sm font-bold mb-2" for="city">City</label>
                    <input onChange={handleChange} class=" text-black shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="city" type="text" placeholder="city" />
                </div>

                <div class="mb-4 text-black">
                    <label class="block text-grey-darker text-sm font-bold mb-2" for="street">Street</label>
                    <input onChange={handleChange} class=" text-black shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="street" type="text" placeholder="street" />
                </div>

                <div class="mb-4 text-black">
                    <label class="block text-grey-darker text-sm font-bold mb-2" for="housenumber">Hausnummer</label>
                    <input onChange={handleChange} class=" text-black shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="housenumber" type="number" placeholder="21" />
                </div>

                <div class="mb-4 text-black">
                    <label class="block text-grey-darker text-sm font-bold mb-2" for="zipcode">Postleitzahl</label>
                    <input onChange={handleChange} class=" text-black shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="zipcode" type="number" placeholder="24118" />
                </div>

                <div class="mb-4 text-black">
                    <label class="block text-grey-darker text-sm font-bold mb-2" for="phonenumbe">Telefonnummer</label>
                    <input onChange={handleChange} class=" text-black shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="phonenumber" type="number" placeholder="012332199312" />
                </div>

                <div class="mb-4 text-black">
                    <label class="block text-grey-darker text-sm font-bold mb-2" for="paypal">PayPal-Account</label>
                    <input onChange={handleChange} class=" text-black shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="paypal" type="email" placeholder="me@paypal.de" />
                </div>

                <div class="mb-4 text-black">
                    <label class="block text-grey-darker text-sm font-bold mb-2" for="username">Email</label>
                    <input onChange={handleChange} class=" text-black shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="username" type="email" placeholder="myemail@spottroup.de" />
                </div>

                <div class="mb-6">
                    <label class="block text-grey-darker text-sm font-bold mb-2" for="password1">Password</label>
                    <input onChange={handleChange} class="shadow appearance-none border border-red rounded w-full py-2 px-3 text-grey-darker mb-3" id="password1" type="password" placeholder="******************" />
                ...
                <div class="mb-6">
                    ...
                    <input onChange={handleChange} class="shadow appearance-none border border-red rounded w-full py-2 px-3 text-grey-darker mb-3" id="password" type="password" placeholder="******************" />
                </div>

                <div class="flex items-center justify-between">
                    <button class="btn border-black text-white hover:text-gray-200 hover:bg-gray-700" type="submit">SignIn</button>
